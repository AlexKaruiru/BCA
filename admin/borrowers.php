						...
						$i = 1;
						 ...
						 <tr>
						 	...
						 	<td>
								...
								<p><small>Location :<b><?php echo $row['location'] ?></small></b></p> 
						 		<p><small>Tax ID :<b><?php echo $row['tax_id'] ?></small></b></p>
								 <p><small>Guarantor :<b><?php echo $row['guarantor'] ?></small></b></p>
								 <p><small>Bank Statement :<b><?php echo $row['bankstatement'] ?></small></b></p> 
