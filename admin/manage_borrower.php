	...
	<div class="col-lg-12">
		<form id="manage-borrower">
			...
			<div class="row form-group">
				...
				<div class="row form-group">
				<div class="col-md-6">
							<label for="">Guarantor info</label>
							<textarea name="guarantor" id="" cols="30" rows="2" class="form-control" required=""><?php echo isset($guarantor) ? $guarantor : '' ?></textarea>
				</div>
				<div class="col-md-5">
					<div class="">
						<label for="">Bank Statememt</label>
						<input type="file" class="form-control" name="bankstatement" value="<?php echo isset($tax_id) ? $tax_id : '' ?>>
