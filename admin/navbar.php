...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=home" class="nav-item nav-link"><i class="fa fa-laptop me-2"></i>Elements</a>
                 <a href="index.php?page=home" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Forms</a>
                 <a href="index.php?page=home" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Tables</a>
				 <a href="index.php?page=home" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Charts</a>
				 <a href="index.php?page=home" class="nav-item nav-link"><i class="far fa-file-alt me-2"></i>Pages</a>
			<?php endif; ?>
		</div>
