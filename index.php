...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="scroll"><a href="#price">Payment</a></li>
                    ...
                    <li class="button-holder">
                        ...
                        <button type="button" class="btn btn-blue navbar-btn"> <a href="https://www.safaricom.co.ke/personal/m-pesa/do-more-with-m-pesa/m-pesa-api" target="_blank">Pay</a></button>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 caption">
                    ...
                    <h1>Welcome To Business Cash Advance</h1>
                    ...
                    <p>Next generation Microfinance</p>
                   ...
                   <!--// <a class="btn btn-blue popup-youtube" href="https://www.youtube.com/watch?v=Q8TXgCzxEnw"> -->
                        ...
                        <i class="material-icons">play_circle_filled</i>Continue
    ...
    <section id="about" class="section-padding">
        ...
        <div class="container">
            ...
            <p>We help you to plan your next business loan with financing options you need</p>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="icon-box">
                        ...
                        <p>To grow, build and maximize the potential of the businesses of the low income and
                            unbanked of Kenya through the provision of affordable, flexible and customer-oriented financial services.</p>
                ...
                <div class="col-md-4">
                    ...
                    <div class="icon-box">
                        ...
                        <p>To be the most efficient microfinance institution in Kenya by being cashless, paperless
                            and data-driven to offer the best value, most flexible and most customer-oriented financial services in the market</p>
                     </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="icon-box">
                        ...
                        <p>BCA delivers financial services that bring financial and social impact to our clients through three core
                         financial products in Group Lending, Individual Loans, and Agricultural loans. BCA has since 2010 disbursed over 260,000 business and agribusiness loans across 12 locations in 6 counties of Kenya.
                ...
                <div class="col-md-6">
                    ...
                    <div class="story-content">
                        ...
                        <div class="story-text">
                            ...
                            <p>Over 68% of the agribusiness loans are to women small holder farmer, who are directly targeted through localized marketing campaigns that are deliberately executed in areas with higher population of women (rural, market places, churches). To date BCA has financed and trained over 2,000 clients with 30% being smallholder farmers.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="icon-box">
                        ...
                        <p>For your agribusiness/ agriculture needs.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>Our features  <area shape="" coords="" href="" alt=""></p>
                    ...
                    <div class="feat-media">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Our rates are very affordable</p>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Access our services quickly</p>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h4 class="media-heading">Accesssible</h4>

                                <p>Reach to us easily through your devices</p>
    ...
    <section id="price" class="section-padding">
        ...
        <div class="container">
            ...
            <p>Check out our diffrent payment plans</p>
                        ...
                        <div class="plan">
                            ...
                            <div class="pricing-body">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><i class="material-icons">done</i><b>a</b> aa</li>
                        ...
                        <div class="plan active">
                            ...
                            <div class="pricing-body">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><i class="material-icons">done</i><b>b</b> bb</li>
                        ...
                        <div class="plan">
                            ...
                            <div class="pricing-body">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><i class="material-icons">done</i><b>C</b> CC</li>
            ...
            <div class="row">
                ...
                <div id="owl-testimonials">
                    ...
                    <div class="item">
                        ...
                        <p class="quote">Very satisfied with BCA.</p>

                        <h4>-John , Company inc.</h4>
            ...
            <form method="post">
                <form class="contact-form">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                        <input type="text" class="form-control" placeholder="Full Name"  value=" Name"  name="t1" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your Name';}" required pattern="[a-zA-z1 _]{1,50}" title"Please Enter Only Characters and numbers between 1 to 50 for Name">
                           <!--  <input type="text" class="form-control" placeholder="Full Name" required="required">-->

                           <div class="form-group">
                           <input type="text" class="form-control" placeholder="Contact" value=" Contact No" name="t2" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your Contact NO';}" required pattern="[0-9]{10,12}" title"Please Enter Only  numbers between 10 to 12 for Contact no">
                           <!--  <input type="text" class="form-control" placeholder="Full Name" required="required">-->

                        </div>

                        <div class="form-group">
                           <input type="text" class="form-control" placeholder="Email" value="Email" name="t3" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your mail';}" required> 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                         ...
                         <textarea onFocus="if(this.value == 'Message') this.value='';" placeholder="Message" name="t4" onBlur="if(this.value == '') this.value='Enter Message Here';" required/ -></textarea>
                    ...
                    <button type="submit" class="btn btn-blue"value="Send message" name="sbmt">Send Message</button>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="footer-caption">
                    ...
                    <h5 class="pull-left">BCA, &copy;2022 All rights reserved</h5>
